package com.yellowbyte.ben.camera;
...
public class OrthoCamera extends OrthographicCamera {
	...
	public OrthoCamera() {
		this(new StretchViewport(BenGame.WIDTH, BenGame.HEIGHT));
	}
	...
	public void resize() {
		StretchViewport virtualViewport = new StretchViewport(BenGame.WIDTH,
				BenGame.HEIGHT);
